...
namespace CreditCardApplications.Tests
{
    public class CreditCardApplicationEvaluatorShould
    {
        ...
        [Fact]
        public void ReferInvalidRFrequentFlyerApplications_ReturnValuesSequence()
        {
            var mockValidator = new Mock<IFrequentFlyerNumberValidator>();
        ...
        [Fact]
        public void ReferInvalidRFrequentFlyerApplications_MultipleCallsSequence()
        {
            var mockValidator = new Mock<IFrequentFlyerNumberValidator>();
            mockValidator.Setup(x => x.ServiceInformation.License.LicenseKey).Returns("OK");
            ...
            // Each time IsValid is called, moq will capture and add it to frequentFlyerNumberPassed
